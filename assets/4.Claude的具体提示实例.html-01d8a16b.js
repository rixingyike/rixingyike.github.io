import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-4e8d5300.js";const i={},l=e(`<h1 id="_4-claude-的具体提示实例" tabindex="-1"><a class="header-anchor" href="#_4-claude-的具体提示实例" aria-hidden="true">#</a> 4.Claude 的具体提示实例</h1><p>即使是简单的提示，例如“请给我写一首关于树的诗”，Claude 也可以生成可用的内容。你可以要求Claude以特定的风格或针对特定的受众进行写作。例如，你可以要求非常详细或更简洁。你还可以要求 Claude 生成大概的单词数、段落数或列表项数。</p><h2 id="_1-重写文本" tabindex="-1"><a class="header-anchor" href="#_1-重写文本" aria-hidden="true">#</a> 1，重写文本</h2><p>在此示例中，我们希望 Claude 以特定样式重写一些现有文本。我们给它两个输入，要重写的文本以及有关如何重写它的说明。</p><p>例如：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>Human: 我想让你用下面的说明重写下面的段落：“{{instructions}}”。
